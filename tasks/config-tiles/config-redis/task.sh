...
om-linux --target "https://${OPSMAN_DOMAIN_OR_IP_ADDRESS}" \
   ...
   configure-product \
   --product-name $PRODUCT_NAME \
   --product-properties "$SYSLOG_PROPERTIES"
...
om-linux --target "https://${OPSMAN_DOMAIN_OR_IP_ADDRESS}" \
   ...
   configure-product \
   --product-name $PRODUCT_NAME \
   --product-properties "$SMALL_PLAN_SETTINGS"
...
om-linux --target "https://${OPSMAN_DOMAIN_OR_IP_ADDRESS}" \
   ...
   configure-product \
   --product-name $PRODUCT_NAME \
   --product-properties "$MEDIUM_PLAN_SETTINGS"
...
om-linux --target "https://${OPSMAN_DOMAIN_OR_IP_ADDRESS}" \
   ...
   configure-product \
   --product-name $PRODUCT_NAME \
   --product-properties "$LARGE_PLAN_SETTINGS"
