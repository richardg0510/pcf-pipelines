...
PRODUCT_PROPERTIES=$(
  jq -n \
    ...
    '
    {
      ".properties.root_service_account_json": $root_service_account_json,
      ".properties.db_host": $db_host,
      ".properties.db_username": $db_username,
      ".properties.db_password": $db_password,
      ".properties.db_port": $db_port,
      ".properties.ca_cert": $ca_cert,
      ".properties.client_cert": $client_cert,
      ".properties.client_key": $client_key
    }
    '
)
